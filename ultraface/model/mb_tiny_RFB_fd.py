...
from ultraface.model.mb_tiny_RFB import Mb_Tiny_RFB
from ultraface import fd_config as config
from ultraface.predictor import Predictor
...
def create_Mb_Tiny_RFB_fd(is_test=False, device="cuda"):
    num_classes = 2
